...
public:
	...
	virtual void Scale(double factor) override; // Scale the line by factor
	...
	virtual void Resize(double newWidth, double newHeight) override; // Resize the line to new width and height
